...
model_path = os.path.join(project_root, "trained", "xgboost_model.joblib")
report_dir = os.path.join(project_root, "report")
confusion_matrix_path = os.path.join(report_dir, "xgboost_confusion_matrix.png")
...
# Note: XGBoost does not require feature scaling for this implementation.
