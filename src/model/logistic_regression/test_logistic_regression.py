...
model_path = os.path.join(project_root, "trained", "logistic_regression_model.joblib")
report_dir = os.path.join(project_root, "report")
confusion_matrix_path = os.path.join(report_dir, "logistic_regression_confusion_matrix.png")
...
# Preprocess the data using the same scaler from training
